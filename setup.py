...
setup(
    ...
    description='Specify and configure a network of domains, devices and servers.',
    long_description=parse_readme(),
    # What does your project relate to? Separate with spaces.
    keywords='nsct development',
    author='Neil Jarvis',
    author_email='neil@jarvis.name',
    license='MIT',

    # The project's main homepage
    url='https://github.com/njarvis/nsct',
