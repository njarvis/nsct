...
## Issue tracker
nsct uses the excellent [GitHub issue tracker][issues].

Personally, I also recommend giving [ZenHub][zenhub] a try. After installing the Google Chrome plugin, visit the [nsct boards][repo-boards]. This way, it's very easy to get an overview of the current bug/feature request situation.
...
### Report Bugs
Report bugs at [njarvis/nsct/issues][issues].
...
### Write Documentation
Network Specification and Configuration Tool could always use more documentation, whether as part of the official Network Specification and Configuration Tool docs, in inline docstrings, or even on the web in blog posts, articles, and such.
...
## Get Started!
Ready to contribute? Here's how to set up `Network Specification and Configuration Tool` for local development.

> Over time my ambition is to provide a reproducable and automated setup through Vagrant.

1. Fork the [njarvis/nsct][repo] repo on GitHub

2. Clone your fork locally:

  ```bash
  $ git clone git@github.com:<your github username>/nsct.git
  ```
...
## Coding conventions
Generally I recommend two ways to stay up-to-date on nsct coding standards.
...
[issues]: https://github.com/njarvis/nsct/issues
[repo]: https://github.com/njarvis/nsct
[repo-boards]: https://github.com/njarvis/nsct/issues#boards
[sourcetree]: http://www.sourcetreeapp.com/
[travis]: https://travis-ci.org/njarvis/nsct/pull_requests
